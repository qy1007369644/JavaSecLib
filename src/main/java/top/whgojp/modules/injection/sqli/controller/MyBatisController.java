 ...
 * 以及获取参数的方式
 */
@Api(value = "MyBatisController", tags = "SQL注入-MyBatis")
@RestController
        ...
        try {
            ...
            switch (type) {
                case "add":
                    ...
                    rowsAffected = usersService.nativeInsert(new Users(Integer.valueOf(id), username, password));
